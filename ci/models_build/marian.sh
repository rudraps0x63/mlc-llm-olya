...
python -m mlc_llm compile --model-type marian "./output-$quantization-opus-mt-$language_pair/" --quantization "$quantization" --device vulkan --output "./output-$quantization-opus-mt-$language_pair/opus-mt-$language_pair.so"
