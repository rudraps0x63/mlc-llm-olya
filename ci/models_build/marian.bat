...
pythom -m mlc_llm compile --model-type marian "./output-$quantization-opus-mt-$language_pair/" --quantization "$quantization" --device "$device" --output "./output-$quantization-opus-mt-$language_pair/opus-mt-$language_pair.so"
