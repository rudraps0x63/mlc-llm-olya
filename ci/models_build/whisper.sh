...
python -m mlc_llm gen_config --model-type whisper-tiny ./output-whisper-$language_pair --quantization "$quantization" --conv-template marian --output "./output-whisper-$quantization"
